...
namespace CTDataGenerator
{
    ...
    public partial class tbl_user_target
    {
        ...
        public int user_target_user_id { get; set; }
        public string user_target_metric_id { get; set; }
        public string user_target_parent_id { get; set; }
        public System.DateTime user_target_goal_timestamp { get; set; }
        public string user_target_creation_timestamp { get; set; }
        public string user_target_completed_timestamp { get; set; }
